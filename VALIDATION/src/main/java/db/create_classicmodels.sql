...
DROP IF NOT EXISTS TABLE Customers;
DROP IF NOT EXISTS TABLE Employees;
DROP IF NOT EXISTS TABLE Offices;
DROP IF NOT EXISTS TABLE OrderDetails;
DROP IF NOT EXISTS TABLE Orders;
DROP IF NOT EXISTS TABLE Payments;
DROP IF NOT EXISTS TABLE Products;
DROP IF NOT EXISTS TABLE ProductLines;
